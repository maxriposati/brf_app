...
contrato_op = [('0', '      ---'), ('1', 'Fijo'), ('2', 'Indefinido'), ('3', 'Prestación de Servicios'), ('4', 'Aprendizaje'), ('5', 'Obra o Labor')]
cargo_op = [('0', '      ---'), ('1', 'Directivo'), ('2', 'Jefatura'), ('3', 'Operativo'), ('4', 'Asistente'), ('5', 'Auxiliar')]
dependencia_op = [('0', '      ---'), ('1', 'Mercadeo'), ('2', 'Comercial'), ('3', 'Talento Humano'), ('4', 'Producción'), ('5', 'Financiero'), ('6', 'Almacén')]
roles = [('0', '      ---'), ('usuario', 'Usuario'), ('administrador', 'Administrador'), ('superAdministrador', 'Super Administrador')]
...
class FormUsuario(FlaskForm):
    ...
    tipo_genero = RadioField('Genero:', choices=[('Masculino','M'),('Femenino','F')])
    ...
    ciudadResidencia = SelectField(u'Ciudad de Residencia:', choices=ciudades_op)
    email = EmailField('E-mail: ')
    #datos de contrato
    tipoContrato = SelectField(u'Tipo de Contrato:', choices=contrato_op)
    cargo = SelectField(u'Cargo:', choices=cargo_op)
    fechaInicio = DateField('Fecha Inicio:')
    fechaFinalizacion = DateField('Fecha Finalización:')
    dependencia = SelectField(u'Dependencia:', choices=dependencia_op)
